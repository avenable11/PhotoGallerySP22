...
import edu.ivytech.photogallerysp22.api.FlickrResponse
import edu.ivytech.photogallerysp22.api.GalleryItem
import edu.ivytech.photogallerysp22.api.PhotoResponse
...
class FlickrFetchr {
    ...
    fun fetchPhotos() : LiveData<List<GalleryItem>> {
        val responseData : MutableLiveData<List<GalleryItem>> = MutableLiveData()
